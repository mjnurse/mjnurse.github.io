...
For fields you want to index, use the simplest analyzer, or maybe don't analyze at all.  By default, `string` fields are `analyzed` as are the strings in any queries on this fields.  The other option is `not_analyzed` - this is field is indexed so it is searchable, but the value is indexed, as a whole, exactly as specified.
...
<hr>
<p class="pagedate">This page was generated by <a href=".">GitHub Pages</a>.  Page last modified: 22/06/14 09:50</p>
