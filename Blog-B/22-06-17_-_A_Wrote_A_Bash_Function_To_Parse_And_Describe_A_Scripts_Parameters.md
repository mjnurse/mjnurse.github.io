...
I am always skipping up and down a bash script as I add parameters to add a description for the parameter in the `help_text` / header.
...
Note: The function parses the case statement between the two comments: `# Start Parse Script Parameters` and `# End Parse Script Parameters`.
...
Calling a script which contains the above function and parameter parsing statement.
