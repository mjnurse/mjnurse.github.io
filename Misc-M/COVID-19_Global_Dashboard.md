...
<label for="vmax">Vertical Axis Max:</label>
<input type="text" id="vmax" name="vmax"><br><br>
<button type="button" onClick="setChartMax();">Click Me!</button>
</form>
</div>
...
<hr>
<p class="pagedate">This page was generated by <a href=".">GitHub Pages</a>.  Page last modified: 21/01/07 16:10</p>
