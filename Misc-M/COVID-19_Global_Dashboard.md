...
<div class="ctryBox"><input type="checkbox" id="ctryCb40" name="ctryCb40" value="USA" onchange="ctryChange(this);" checked /> - <label for="ctryCb40">USA</label></div>
<div class="ctryBox"><input type="checkbox" id="ctryCb41" name="ctryCb41" value="Ukraine" onchange="ctryChange(this);" /> - <label for="ctryCb41">Ukraine</label></div>
...
<hr>
<p class="pagedate">This page was generated by <a href=".">GitHub Pages</a>.  Page last modified: 20/12/30 13:18</p>
