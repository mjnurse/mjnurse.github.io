*Note*: This page is automatically generated using Usage: sck [options] r [<search words>]
Try "sck -h" for more information
    "sck <search words>" to search of a shortcut-key
    "sck ." to list all records
---
...
# "VS Code","CTRL+K, CTRL+0","Fold all code"
...
<hr>
<p class="pagedate">This page was generated by <a href=".">GitHub Pages</a>.  Page last modified: 22/06/29 12:06</p>
