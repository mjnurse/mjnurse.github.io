...
Hierarchy:
 ...
 Super Type | Sub Class | Type 
 --- | --- | ---
 Any | AnyVal | Double <br> Float <br> Long <br> Int <br> Short <br> Byte <br> Char <br> Unit<br> Boolean
 Any | AnyRef | List <br> Iterable <br> Seq <br> Strings <br> Other Scala / Java Classes
...
```
<hr>
<p class="pagedate">This page was generated by <a href=".">GitHub Pages</a>.  Page last modified: 21/12/22 13:31</p>
