...
<table><tr><td>`compareTo`</td><td>defn: `String1.compareTo(string2)`  greater/less/equal</td></tr></table>
...
`equals` |           defn: String1.equals(String2)
---|---
`equalsIgnoreCase` | defn: String1.equals(String2)
...
```scala
// compareTo      defn: String1.compareTo(string2)  greater/less/equal
"A".compareTo("A") // Yields: 0
"A".compareTo("B") // Yields: -1
"C".compareTo("A") // Yields: 2
```
...
// intersect      defn: String1.intersect(String2)
"Martin".intersect("tank") // Yields: "atn"

// matches        defn: String1.matches(String2) String2 is Regex Expression
"martin".matches("m.{4}n") // Yields: true 

// split          defn: String.split(Character)
...
<hr>
<p class="pagedate">This page was generated by <a href=".">GitHub Pages</a>.  Page last modified: 22/01/05 17:35</p>
