...
### **intersect**
```scala
defn: String1.intersect(String2)
"Martin".intersect("tank") // Yields: "atn"
```

### **matches**
```scala
String1.matches(String2) - String2 is Regex Expression
...
<hr>
<p class="pagedate">This page was generated by <a href=".">GitHub Pages</a>.  Page last modified: 22/01/05 18:36</p>
