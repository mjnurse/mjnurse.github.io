...
Functions can be passed as parameters into functions.  For Example:

```scala
def add(a: Int, b: Int): Int = a + b
def functionPrinter(f: (Int, Int), x: Int, y: Int) = {
   println(f(x, y))
}
```
...
<hr>
<p class="pagedate">This page was generated by <a href=".">GitHub Pages</a>.  Page last modified: 22/01/17 17:47</p>
