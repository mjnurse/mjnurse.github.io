...
matches | `"martin".matches("m.{4}n")` Yields: `true`| `[var/String].matches([regex])`
split | `"a b c".split(' ')` | Yields: `Array("a", "b", "c")`
toLowerCase | `"HI".toLowerCase` |
toString | `val v = 123; v.toString` | As toString has no parameters the () are omitted.
toUpperCase | `"hello".toUpperString` |
...
<hr>
<p class="pagedate">This page was generated by <a href=".">GitHub Pages</a>.  Page last modified: 22/01/04 15:55</p>
