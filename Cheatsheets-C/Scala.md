...
### `compareTo` 
defn: `String1.compareTo(string2)`  greater/less/equal
```scala
...
#### compareTo      `String1.compareTo(string2)  greater/less/equal`
```scala
"A".compareTo("A") // Yields: 0
"A".compareTo("B") // Yields: -1
"C".compareTo("A") // Yields: 2
...
<hr>
<p class="pagedate">This page was generated by <a href=".">GitHub Pages</a>.  Page last modified: 22/01/05 17:51</p>
