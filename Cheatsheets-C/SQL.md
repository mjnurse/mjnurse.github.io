...
ENUM
SET
Here are some more SQL commands:
SQL Constraints
NOT NULL Constraint
...
FULL JOIN table2
ON table1.column_name = table2.column_name;
Here are some more SQL commands and concepts:
SQL Subqueries
...
These are just a few of the most commonly used SQL commands and functions.


<hr>
<p class="pagedate">This page was generated by <a href=".">GitHub Pages</a>.  Page last modified: 23/06/08 13:35</p>
