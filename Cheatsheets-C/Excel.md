...
```
=IFERROR(SUBSTITUTE(LOWER(A1),"b","")/2^30
        ,LEFT(A1,LEN(A1)-2)*
         SWITCH(RIGHT(LOWER(A1),2),"tb",2^10,"gb",1,"mb",1/2^10,"kb",1/2^20,-1))
```
...
<hr>
<p class="pagedate">This page was generated by <a href=".">GitHub Pages</a>.  Page last modified: 23/08/02 12:13</p>
