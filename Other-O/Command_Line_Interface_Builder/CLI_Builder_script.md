...
while IFS= read -r line ; do
  if [[ "${line:0:1}" == "=" ]]; then
    ...
    echo 2
    usage=${line%% ::*}
    if echo $line | grep "##"; then help="$(echo $line | sed 's/^.*## */# /')"; else help=""; fi
    echo 3
    word_list="${line%%::*}"
    word_list=${word_list//[/ [ }
    word_list=${word_list//]/ ] }
...
<hr>
<p class="pagedate">This page was generated by <a href=".">GitHub Pages</a>.  Page last modified: 25/03/28 18:16</p>
