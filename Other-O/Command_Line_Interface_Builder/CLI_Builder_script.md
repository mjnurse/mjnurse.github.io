...
while IFS= read -r line ; do
  if [[ "${line:0:1}" == "=" ]]; then
    ...
    usage=${line%% ::*}
    if echo $line | grep "##" > /dev/null; then help="$(echo $line | sed 's/^.*## */# /')"; else help=""; fi
    word_list="${line%%::*}"
    word_list=${word_list//[/ [ }
    word_list=${word_list//]/ ] }
...
<hr>
<p class="pagedate">This page was generated by <a href=".">GitHub Pages</a>.  Page last modified: 25/04/09 12:08</p>
