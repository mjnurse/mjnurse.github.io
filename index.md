...
<p class="bloglist"><img src="images\/Dot.png" width="15px"> 22-05-18 -  <a class="bloglistlink" id="listitem9" href="Blog-B/22-05-18_-_Read_Aloud_In_MS_Word.html">Read Aloud In MS Word</a> <span style="color: grey">(9)</span></p>
<p class="bloglist"><img src="images\/Dot.png" width="15px"> 22-03-22 -  <a class="bloglistlink" id="listitem10" href="Blog-B/22-03-22_-_LDAP_SAML.html">LDAP SAML</a> <span style="color: grey">(10)</span></p>
<p class="bloglist"><img src="images\/Dot.png" width="15px"> 21-02-23 -  <a class="bloglistlink" id="listitem11" href="Blog-B/21-02-23_-_Useful_Elasticsearch_cURLS.html">Useful Elasticsearch cURLS</a> <span style="color: grey">(11)</span></p>
<p class="bloglist"><img src="images\/Dot.png" width="15px"> 21-01-11 -  <a class="bloglistlink" id="listitem12" href="Blog-B/21-01-11_-_HTML_datalist.html">HTML datalist</a> <span style="color: grey">(12)</span></p>
<p class="bloglist"><img src="images\/Dot.png" width="15px"> 20-12-21 -  <a class="bloglistlink" id="listitem13" href="Blog-B/20-12-21_-_Javascript_ASYNC_AWAIT_By_Example.html">Javascript ASYNC AWAIT By Example</a> <span style="color: grey">(13)</span></p>
<p class="bloglist"><img src="images\/Dot.png" width="15px"> 20-12-10 -  <a class="bloglistlink" id="listitem14" href="Blog-B/20-12-10_-_Async_Await_with_Array_Assignment.html">Async Await with Array Assignment</a> <span style="color: grey">(14)</span></p>
