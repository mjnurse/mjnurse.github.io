...
USAGE
  sck [options] [<parameters>] [<search words>]
...
if [[ \"$1\" == \"\" ]]; then
  echo \"$\{usage\}\"
  echo \"$\{try\}\"
  echo \"    \\\"sck <search words>\\\" to search of a shortcut-key\"
  ...
  case $1 in 
    ...
    -a|--add)
      ...
      if [[ \"$1\" == \"\" ]]; then
        ...
        read -p \"Sub-Heading: (can be blank)\" s
...
<hr>
<p class="pagedate">This page was generated by <a href=".">GitHub Pages</a>.  Page last modified: 22/07/26 18:10</p>
