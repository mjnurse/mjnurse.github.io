...
case $1 in
  ...
  -t|--tasksheet)
    ...
    csvsql $tmpcsvfile "
    SELECT task, Mon, Tue, Wed, Thu, Fri
    FROM (
      ...
      SELECT 1, STRFTIME('%W',DATE('20'||REPLACE(dte,'/','-'))) AS week
           , '', SUBSTR(MIN(dte),4), '', '' ,'', SUBSTR(MAX(dte), 4)
      FROM '$tmpcsvfile' 
      WHERE dte >= '$2'
      GROUP BY 1, 2
      UNION
...
<hr>
<p class="pagedate">This page was generated by <a href=".">GitHub Pages</a>.  Page last modified: 23/09/29 15:18</p>
