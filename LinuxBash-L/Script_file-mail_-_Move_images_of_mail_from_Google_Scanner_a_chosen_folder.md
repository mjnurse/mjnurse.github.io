---
title: file-mail - Move images of mail from Google Scanner a chosen folder
---
...
help_text="
NAME
   file-mail - Takes images of mail from Google Scanner and moves these to a chosen folder.

USAGE
   file-mail [options] <parameters>
